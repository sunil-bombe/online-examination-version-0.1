        ...
        <form action="newSubject" method="POST" >
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="email-input" class=" form-control-label">Subject Name</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="email" name="subject"  placeholder="Subject" class="form-control" required="">
                                                    
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Exam Time</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="mobilenumber" name="examTime" placeholder="Time in hours" class="form-control"  required="">
                                             ...
                                             <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Subject Status</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                <select name="subjectStatus" class="form-control">
