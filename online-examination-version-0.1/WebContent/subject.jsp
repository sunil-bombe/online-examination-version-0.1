<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
      ...
      <%@ page import="com.webwork.online.examination.service.SubjectService" %>
 <%@ page import="com.webwork.online.examination.service.impl.SubjectServiceImpl" %>
 <%@ page import="com.webwork.online.examination.model.Subject" %>
  ...
  <main role="main">
    <div class="jumbotron">
      <div class="col-sm-12 mx-auto">
          ...
          <h2 class="mt-4 text-center">All Subject List</h2>
           <a href="add-subject.jsp"><button class="btn btn-success">Add Subject</button></a>
          <a class="btn btn-primary" href="user-data.jsp" role="button">Start Test &raquo;</a>  
        <%
          int count = 0;
          ...
          for(Subject subject: subjectList){
        	  count++;
			   ...
			   <tr>
			    <td><h5><%= count %></h4></td>
			   <td><h5><%= subject.getSubject() %></h5></td>
			   <td><h5><%= subject.getSubjectStatus() %></h5></td>
			   <td><h5><%= subject.getExamTime() %> :Hours </h5></td>
			   </tr>
			   </table>  
			   </div>
			   <div class="col-sm-4">
			   <table  class="table table-responsive">
			   <tr>
			    <td><h5><a href="QuestionPaper?subject=<%= subject.getSubject() %>&page=admin-subject-question.jsp"  class="btn btn-primary btn-sm">View</a></h5></td>
			    <td><h5><button class="btn btn-danger btn-sm">Delete</button></h5></td>
			   </tr>
			   </table>
			   </div>
